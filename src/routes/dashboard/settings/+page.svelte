...
<h1 class="text-xl font-semibold text-ink mt-2 mb-6">Settings</h1>

<div class="text-[10px] font-bold tracking-[0.14em] uppercase text-stone-muted mb-4">Projects</div>
	...
	<div class="mb-8">
		...
		{#each team.projects as project}
			<a
				...
				class="block text-sm text-sage hover:underline py-1"
			>
				{project.name}
			</a>
		{/each}
