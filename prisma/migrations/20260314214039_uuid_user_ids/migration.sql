/*
  ...
  - Changed the type of `assignedTo` on the `Task` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
ADD COLUMN     "assignedTo" UUID NOT NULL;
